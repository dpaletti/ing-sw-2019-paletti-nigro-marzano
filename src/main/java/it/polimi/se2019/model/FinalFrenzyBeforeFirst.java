...
public class FinalFrenzyBeforeFirst extends PlayerDamage {
    ...
    public List<List<PartialCombo>> getMoves() {
        moves.clear();
        moves.add(Arrays.asList(PartialCombo.MOVE, PartialCombo.RELOAD, PartialCombo.SHOOT));
        moves.add(Arrays.asList(PartialCombo.MOVE, PartialCombo.MOVE, PartialCombo.MOVE, PartialCombo.MOVE));
